<script>
  ...
  let argTypes = {
    ...
    frameRatioHeight: { control: "number" },
    frameRatioWidth: { control: "number" },
    loop: { control: "boolean" },
    srcURL: { control: "text" },
    videoCaptionTracks: { control: "object" },
  };
</script>

<Meta title="components/videos/Video" component={Video} {argTypes} />
