...
export const Default = () => ({
  ...
  props: { srcURL: "video/video-small.jpg", alt: "This is the alt text", articleData },
});

export const HalfHeight = () => ({
  Component: ViewDefault,
  props: { srcURL: "video/video-small.jpg", alt: "This is the alt text", coverHeight: "50vh", articleData },
});
