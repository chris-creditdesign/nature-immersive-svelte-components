<script lang="ts">
	import type { ArticleData } from '$lib/types.js';
	...
	let lastMenuLinkElem: HTMLAnchorElement | null = null;
	let buttonElement: HTMLButtonElement | null = null;
	let handleButtonBlur: () => void;
...
<a href="#main-content" class="skip-link font-family:sans-serif"> Skip to main content </a>
